...
@ManagedBean(name = "busEmpleado")
@SessionScoped
public class BusEmpleado implements Serializable {
			...
			if (listEmpleados != null) {
				...
				if (listEmpleados.size() == 0) {
					FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
							"Información.", "No se encontró el funcionario."));
				}

			} else {
				FacesContext.getCurrentInstance().addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_WARN, "Información.", "No se encontró el funcionario."));
			}
